...
export const getAppSetId = () => getSupportedPlatformInfoAsync({
  memoKey: 'appSetId',
  defaultValue: {
    id: 'unknown',
    scope: -1
...
const [getInstallerPackageNameInternal, getInstallerPackageNameSyncInternal] = getSupportedPlatformInfoFunctions({
...
const [getSystemAvailableFeaturesInternal, getSystemAvailableFeaturesSyncInternal] = getSupportedPlatformInfoFunctions({
  supportedPlatforms: ['android'],
...
const [isWiredHeadphonesConnectedInternal, isWiredHeadphonesConnectedSyncInternal] = getSupportedPlatformInfoFunctions({
  supportedPlatforms: ['android', 'ios'],
...
const [isBluetoothHeadphonesConnectedInternal, isBluetoothHeadphonesConnectedSyncInternal] = getSupportedPlatformInfoFunctions({
  supportedPlatforms: ['android', 'ios'],
...
const [getSupportedMediaTypeListInternal, getSupportedMediaTypeListSyncInternal] = getSupportedPlatformInfoFunctions({
  supportedPlatforms: ['android'],
...
const [getAvailableLocationProvidersInternal, getAvailableLocationProvidersSyncInternal] = getSupportedPlatformInfoFunctions({
  supportedPlatforms: ['android', 'ios'],
