import type { Energy, InstantaneousRecord, IntervalRecord, BloodGlucose, Power, Pressure, Temperature, TimeRangeFilter, Mass, Length, CyclingPedalingCadenceSample, HeartRateSample, Volume, SpeedSample, StepsCadenceSample, PowerSample, ExerciseSegment, ExerciseLap, SleepStage, ExerciseRoute, ZoneOffset } from './base.types';
