...
import type { HealthConnectRecord, Permission, WriteExerciseRoutePermission, ReadHealthDataHistoryPermission } from './types';
...
export interface Spec extends TurboModule {
    ...
    requestPermission(permissions: (Permission | WriteExerciseRoutePermission | ReadHealthDataHistoryPermission)[]): Promise<Permission[]>;
