...
const TemperatureMeasurementLocation = exports.TemperatureMeasurementLocation = {
  ARMPIT: 1,
  EAR: 8,
  FINGER: 2,
  FOREHEAD: 3,
...
const MealType = exports.MealType = {
  BREAKFAST: 1,
  DINNER: 3,
  LUNCH: 2,
  SNACK: 4,
...
const RelationToMeal = exports.RelationToMeal = {
  AFTER_MEAL: 4,
  BEFORE_MEAL: 3,
  FASTING: 2,
  GENERAL: 1,
...
const SpecimenSource = exports.SpecimenSource = {
  CAPILLARY_BLOOD: 2,
...
const CervicalMucusAppearance = exports.CervicalMucusAppearance = {
  UNKNOWN: 0,
  DRY: 1,
  STICKY: 2,
  CREAMY: 3,
...
const CervicalMucusSensation = exports.CervicalMucusSensation = {
  UNKNOWN: 0,
  LIGHT: 1,
  MEDIUM: 2,
  HEAVY: 3
};
const ExerciseType = exports.ExerciseType = {
  OTHER_WORKOUT: 0,
  BACK_EXTENSION: 1,
  BADMINTON: 2,
...
const ProtectionUsed = exports.ProtectionUsed = {
  UNKNOWN: 0,
  PROTECTED: 1,
  UNPROTECTED: 2
};
const MenstruationFlow = exports.MenstruationFlow = {
  UNKNOWN: 0,
  LIGHT: 1,
  MEDIUM: 2,
  HEAVY: 3
...
const Vo2MaxMeasurementMethod = exports.Vo2MaxMeasurementMethod = {
  OTHER: 0,
  METABOLIC_CART: 1,
  HEART_RATE_RATIO: 2,
  COOPER_TEST: 3,
...
const OvulationTestResult = exports.OvulationTestResult = {
  /**
...
const ExerciseSegmentType = exports.ExerciseSegmentType = {
