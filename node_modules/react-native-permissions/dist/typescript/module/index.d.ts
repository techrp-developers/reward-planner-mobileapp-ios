...
export declare const check: (permission: import("./types.js").Permission) => Promise<import("./types.js").PermissionStatus>;
export declare const checkLocationAccuracy: () => Promise<import("./types.js").LocationAccuracy>;
export declare const checkMultiple: <P extends import("./types.js").Permission[]>(permissions: P) => Promise<Record<P[number], import("./types.js").PermissionStatus>>;
export declare const checkNotifications: () => Promise<import("./types.js").NotificationsResponse>;
export declare const openContactPicker: () => Promise<void>;
...
export declare const request: (permission: import("./types.js").Permission, rationale?: import("./types.js").Rationale) => Promise<import("./types.js").PermissionStatus>;
export declare const requestLocationAccuracy: (options: import("./types.js").LocationAccuracyOptions) => Promise<import("./types.js").LocationAccuracy>;
export declare const requestMultiple: <P extends import("./types.js").Permission[]>(permissions: P) => Promise<Record<P[number], import("./types.js").PermissionStatus>>;
export declare const requestNotifications: (options?: import("./types.js").NotificationOption[], rationale?: import("./types.js").Rationale) => Promise<import("./types.js").NotificationsResponse>;
declare const _default: {
    ...
    check: (permission: import("./types.js").Permission) => Promise<import("./types.js").PermissionStatus>;
    checkLocationAccuracy: () => Promise<import("./types.js").LocationAccuracy>;
    checkMultiple: <P extends import("./types.js").Permission[]>(permissions: P) => Promise<Record<P[number], import("./types.js").PermissionStatus>>;
    checkNotifications: () => Promise<import("./types.js").NotificationsResponse>;
    ...
    request: (permission: import("./types.js").Permission, rationale?: import("./types.js").Rationale) => Promise<import("./types.js").PermissionStatus>;
    requestLocationAccuracy: (options: import("./types.js").LocationAccuracyOptions) => Promise<import("./types.js").LocationAccuracy>;
    requestMultiple: <P extends import("./types.js").Permission[]>(permissions: P) => Promise<Record<P[number], import("./types.js").PermissionStatus>>;
    requestNotifications: (options?: import("./types.js").NotificationOption[], rationale?: import("./types.js").Rationale) => Promise<import("./types.js").NotificationsResponse>;
};
