...
export declare const openContactPicker: jest.Mock<Promise<void>, [], any>;
...
declare const _default: {
    ...
    checkMultiple: <P extends import("../index.js").Permission[]>(permissions: P) => Promise<Record<P[number], PermissionStatus>>;
    checkNotifications: () => Promise<import("../index.js").NotificationsResponse>;
    openContactPicker: jest.Mock<Promise<void>, [], any>;
    ...
    requestMultiple: <P extends import("../index.js").Permission[]>(permissions: P) => Promise<Record<P[number], PermissionStatus>>;
    requestNotifications: (options?: import("../index.js").NotificationOption[], rationale?: import("../index.js").Rationale) => Promise<import("../index.js").NotificationsResponse>;
};
