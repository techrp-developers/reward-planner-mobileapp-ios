...
const getPlistPath_js_1 = __importDefault(require("./getPlistPath.js"));
/**
...
async function getPlist(project, sourceDir, targetUUID) {
    ...
    const plistContent = await dntShim.Deno.readFile(plistPath).then((buf) => {
        const decoder = new TextDecoder("utf-8");
        return decoder.decode(buf);
    });
    return plist_1.default.parse(plistContent);
}
