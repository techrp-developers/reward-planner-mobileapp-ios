...
const styles = StyleSheet.create({
  ...
  card: { width: '100%', borderRadius: rs(26), paddingHorizontal: rs(22), overflow: 'hidden', borderWidth: 1, borderColor: 'rgba(139,143,255,0.25)' },
  ...
  qrArea: { alignItems: 'center', marginTop: rs(20) },
