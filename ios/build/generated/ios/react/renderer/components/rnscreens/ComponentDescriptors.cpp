...
registry->add(concreteComponentDescriptorProvider<RNSFormSheetContentWrapperComponentDescriptor>());
...
registry->add(concreteComponentDescriptorProvider<RNSStackHeaderItemSpacerIOSComponentDescriptor>());
